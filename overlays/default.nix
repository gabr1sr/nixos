...
final: prev: {
  ...
  vscode-extensions = final.lib.recursiveUpdate prev.vscode-extensions {
    ...
    "juanblanco"."solidity" = final.vscode-utils.extensionFromVscodeMarketplace {
      name = "solidity";
    ...
    "tintinweb"."graphviz-interactive-preview" = final.vscode-utils.extensionFromVscodeMarketplace {
    ...
    "tintinweb"."vscode-solidity-language" = final.vscode-utils.extensionFromVscodeMarketplace {
    ...
    "tintinweb"."solidity-visual-auditor" = final.vscode-utils.extensionFromVscodeMarketplace {
